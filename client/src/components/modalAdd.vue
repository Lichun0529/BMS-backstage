    ...
    <div class="modalAdd modal-content shadow-soft">
      ...
      <form @submit.prevent="save" id="myForm">
        ...
        <div data-v-ff9c8678 class="modal-footer">
            <button type="submit" class="btn btn-primary text-success">Save<span v-show="showLoading" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></button>
